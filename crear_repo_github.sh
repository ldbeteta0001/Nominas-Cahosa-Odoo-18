...
# Script para crear repositorio "Nominas Cahosa Odoo 18" en GitHub
# Uso: ./crear_repo_github.sh TU_TOKEN_AQUI

REPO_NAME="Nominas-Cahosa-Odoo-18"
DESCRIPTION="Módulos de Nómina y Recursos Humanos para Odoo 18 - Cahosa"
...
echo "  git add ."
echo "  git commit -m 'Initial commit: Módulos de Nómina Cahosa Odoo 18'"
